    ...
    5083: (e, t, n) => {
      ...
      const u = {
        ...
        p = function (e, t) {
          ...
          return v.bandwidthEstimate = (0, s.qh)(P) ? P : function (e) {
            const t = parseFloat(e);
            return (0, s.qh)(t) ? Math.max(t, 1) : u.bandwidthEstimate
          }(v.defaultBandwidthEstimate), v.bitrateSelection = (0, s.qh)(x) ? x : u.bitrateSelection, v.liveSyncDuration = d(v.liveSyncDuration), v.backgroundLoading = (0, s.jn)(v.backgroundLoading) ? v.backgroundLoading : a.Features.backgroundLoading, v
        }
    },
    2894: (e, t, n) => {
      "use strict";
    ...
    623: (e, t, n) => {
      ...
      const T = function (e) {
        ...
        Z = e => A(e) ? Promise.resolve() : P(e).then((() => {
          if (e.get("drm") || (0, S.w0)(e.get("playlist"))) return (0, S.lD)(e.get("edition"))
        })).then((() => {
          return P(t = e).then((() => {
            if (x(t)) return;
